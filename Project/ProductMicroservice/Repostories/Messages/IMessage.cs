...
namespace ProductMicroservice.Repostories.Messages
{
    public interface IMessage
    {
       ...
       /* public void SendingMessageCheckExistCategory<T>(T message);*/
        ...
        //sending message
        public void SendingMessage1<T>(T message, string exchangeName, string queueName, string routingKey, string exchangeType, bool exchangeDurable, bool queueDurable, bool exclusive, bool autoDelete);
